...
const Layout = () => {
  ...
  return (
    <div className='md:flex md:min-h-screen'>
        ...
        <div className='md:w-1/4 bg-blue-900 px-5 py-10'> {/* el ancho representa 1/4 del espacio */}
        ...
        <div className='md:w-3/4 p-10 bg-gray-100 md:h-screen overflow-scroll'> {/* el ancho representa 3/4 del espacio */}
          <Outlet />
        </div>
    </div>
  )
